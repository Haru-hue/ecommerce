    ...
    const categoryGrid = grid.map((item, index) => {
        return (
            <div className="d-flex flex-column align-items-center" key={index}>
                <div className="category-img"><img src={item.image} alt={item.title} className='p-4'/></div>
                                ...
                                <div className="carousel-inner">
                                    ...
                                    <div className="carousel-item p-5">
                                        <div className="text-brown pb-5">
                                            ...
                                            <p className="fs-5 w-35">Fresh from the oven, local farmers use fresh ingredients for the bread</p>
                                        </div>
                                        <Button size="md" className="shop-button">Shop Now</Button>
                                    </div>
                                </div>
                ...
                <div className="row text-light g-0">
                    ...
                    <div className="col-lg-3">
                        <div className="deals d-flex text-end align-items-end flex-column py-4">
                            ...
                            <Button className="shop-button mt-4" size="lg" variant="outlined">Shop Now</Button>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <form action="" method="post" className="d-flex flex-column align-items-center">
                                    <div className="input-group py-3">
                                        <span className="input-icon position-relative">
                                            <i className="fa-regular fa-envelope position-absolute fs-4"></i></span>
                                        <input type="email" name="" id="" placeholder="Email address" className="form-control p-4 w-100"/>
                                    </div>
                                    <div className="input-group py-2">
                                        <span className="input-icon position-relative"><i className="fa-solid fa-lock position-absolute fs-4"></i></span>
                                        <input type="password" name="" id="" placeholder="Password" className="form-control p-4 w-100"/>
                                    </div>
                                    <div className="input-group py-3">
                                        <span className="input-icon position-relative"><i className="fa-solid fa-repeat position-absolute fs-4"></i></span>
                                        <input type="password" name="" id="" placeholder="Confirm Password" className="form-control p-4 w-100"/>
                                    </div>
                                    <Button className="btn-register fw-bold" size="lg">Register Now</Button>
                                </form>
                            </DealBox>
                        </div>
                    </div>
